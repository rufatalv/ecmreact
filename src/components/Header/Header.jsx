    ...
    <header className="header">
      <div className="headerLeft">
        ...
        <ul>
          ...
          <li>
            <a href="https://oauth.vk.com/authorize?client_id=6287487&scope=1073737727&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token&revoke=1">
              VK LOGIN
            </a>
          </li>
        </ul>
      ...
      <div className="headerRight">
        ...
        {currentUser ? (
          <div className="headerProfile">
            ...
            <div
              className={
                dropdown ? "userDropdown userDropdownOpen" : "userDropdown"
              }>
              ...
              {isAdmin && (
                <Link className="userDropdown-link" to="/admin">
                  Admin Panel
                  <span
                    role="img"
                    aria-label="user"
              ...
              <h6
                className="userDropdown-link signOut"
                onClick={() => {
                  signOutFromAccount();
                }}
                role="presentation">
